...
NVA Computers or Nikola Vukomanovic Arnhem Computers is made, designed and deployed as a final project at Code Institute. I chose this specific webshop because I like tech and I always like looking at the newest tech around. The design is based of Code Institutes 'Boutique Ado' project with me adding some extra functions. Also minor visual changes have been made like the addition of a footer and certain elements change the way a user can explore the site. Of course the colors have been changed completely and my personal favorite is the added darkmode which works on every page and remains in darkmode even when you go to another page of the site. The site has been made usable for all mobile devices and pc's.

![Am I Responsive Image](/readme_media/amiresponcive.png)

##  UX
### Visitor Goals 
    - To be able to register for an account
    - To see all orders a customer has ordered
    - To be able to see every detail about the product
    - To be able to add and/or update delivery information once signed in
    - To easily find what they are looking for and easily navigate the site
...
### Business Goals
    ...
    - To be able to confirm once a complain or question has been handled with inside the admin
...
| ----------- | ----------- | ----------- |
| Site visitor | Easy access to most pages on top and bottom of the site | Easily  find the page I'm looking for |
| Site visitor | Have quick access for all products on the page | Make a quick purchase |
| Site visitor | Have quick access to the shopping bag | See all items inside the shopping bag |
| Site visitor | Have quick access to deals | Get the best deals available |

#### Product Sorting and Searching
| AS A    | I WANT TO BE ABLE TO ... | SO THAT I CAN... |
| ----------- | ----------- | ----------- |
| Site visitor | Enter a search query inside a search bar| Find what I'm looking for much easier |
| Site visitor | Categorize the products by price and name | See the cheapest or best reviewed item |
| Site visitor | Add items to a wishlist | Take a closer look later much easier |
| Site visitor | Have easy access to all categories | Sort items out as soon as I get on the site |

#### Accounts 
| AS A    | I WANT TO BE ABLE TO ... | SO THAT I CAN... |
| ----------- | ----------- | ----------- |
| Site visitor | Make an account | Use all available functions on the site |
| Site visitor | Easy login and out | Login and out quick and easy |
| Site visitor | Reset password | Get access to my account back |
...
| Site visitor | Receive a confirmation mail | Get more confirmation that the order has been made |

#### Contact and services
| AS A    | I WANT TO BE ABLE TO ... | SO THAT I CAN... |
| ----------- | ----------- | ----------- |
| Site visitor | Easy contact the company | Ask my questions, complains etc.. |
| Site visitor | Receive a confirmation mail | Get confirmation that the question has been sent |
| Site visitor | Contact via social media | Get a faster response |
| Site visitor | Subscribe to a newsletter | Get information on deals or other company information |

#### Admin
| AS A    | I WANT TO BE ABLE TO ... | SO THAT I CAN... |
| ----------- | ----------- | ----------- |
| Admin | Easily  add, edit or remove products | Change the stock of my store |
| Admin | Add more categories | Expand to get more customers |
| Admin | Manage users accounts | Help my customers if something goes wrong |
| Admin | Manage customers that have contacted me | Respond to them |
...
football club. I only used a slightly darker tone of yellow than that of the club to make it more pleasant to read. 
...
![Color pallet lightmode](/readme_media/colors.png)
...
![Color pallet darkmode](/readme_media/colorsdm.png)
...
![Agile Tool](/readme_media/agiletool.png)

- I tried making a very basic Agile strategy for my user stories. A basic kahban board with labels must have, should-have and could have. All user stories are done so I
...
- Besides the darkmode button the header contains a dropdown navbar. Within the navbar there is another dropdown that opens on the right side of the first dropdown. In here you will find all the categories of the site.
...
- Last but not least there is the shopping bag button which once clicked will take you to the shopping bag page. It will also count the total amount inside the shopping bag.

![Dropdown Navbar](/readme_media/my-account-bag.png)

#### Header for Mobile

- All elements are in the same place except for the searchbar which is pushed under all the buttons and logo. Instead of the dropdown navbar there is a dropdown hamburger menu. The menu contains everything that is normally inside the My Account page and the entirety of the dropdown navbar.

![Mobile Header](/readme_media/mobile-navbar.png)

#### Footer

- On the very left there are links to every single category that the site contains. Once hovered over them the background will turn white to make it easier to click the right one.
...
- Besides the My Account links the middle section also contains the Mailchimp button. Once clicked the form will appear where you can subscribe to the newsletter. If clicked on accidentally there is a cancel button which will make the form disappear.
...
- The mobile footer is just like the navbar different. You will find that the cattegories section has been removed. The reason being I didn't want the footer to be a mile long. The user on mobile can always use the navbar as it will follow you as you scroll down. All the other elements including the Mailchimp form are still there.

![Mobile Footer](/readme_media/footer-mobile.png)

#### All Products Page

- On the top right corner of the all products page there is a counter which counts how many products are on the page. This makes it easier for the admin to see how many products he or she has on their site.
...
- The product cards contain the most basic information which should be enough. This contains the product picture, price, rating and name.
- The admin of the page gets 2 additional buttons to the cards which are edit and remove. Edit will take you to the editor of that product and remove will remove the product.
...
- Above all the information you will find a Add to Wishlist button. This does exactly that, it will add that product to the wishlist. Once added the button changes to Remove from Wishlist which removes that item from your wishlist.
...
- The rating per product is based on the Reviews a user leaves behind. If there if no review it will simply say No Rating and if someone leaves a Review with a Rating it will be counted up. The more Ratings the more the number will change, this is because the function behind this counts every rating and than takes an average which is then displayed.
...
- After the entire form has been filled out you will see a Title on top, besides that the Rating you left behind, underneath the Review text itself and lastly underneath all that the username, date and time of posting.

![Reviews](/readme_media/reviews.png)

#### Wishlist Page

- The Wishlist page looks exactly like the all products page except it depends on how many items the user has added.
...
- Once sent a confirmation mail is being received  with information on how many days it will take to respond.
- This is also being sent to the admin page so the site admin can easily  find it.
...
- The form requires to be filled in completely for it to work.
...
- This is the last step once placing an order. If logged in and the shipping information has been filled in it will automatically be filled in here. Only your name and creditcard number is what remains to be filled in before you are allowed to continue.
- Here you will also get one last look at the product names and total price.
- Once successfull you will be taken to a success page with all order information.
- At the same time this information is being sent to the admin page.
- And lastly you will receive a confirmation email with all the information about the order.
...
- See the amount of reviews on a product page. 
- A pc building system which allows users to build their own computer with the correct parts that are available on the site.
...
- The products are being bought from the manufacturers directly.
...
- In the footer there is also a [Mailchimp](https://mailchimp.com/) form where users can register to receive news and offers.
...
- For testing view the separate [TESTING.md](TESTING.md) file.
...
- The reviews have been written by me to test the functionality
...
- My new mentor Tim Nelson for the extreme amounts of time in a short period of time.
